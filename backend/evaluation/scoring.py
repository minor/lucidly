...
Uses an ELO-style rating system (base 500, range 0-1000) that
weighs accuracy (70%), time (15%), and cost (15%).
Low accuracy is heavily penalized.

Sub-scores are mapped to 0-1000 for display compatibility.
"""
